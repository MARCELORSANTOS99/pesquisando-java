...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pergunta perg1 = new Pergunta(null, "Em que vc vai votar?","Sim","Sim",true,city,null);
		Pergunta perg2 = new Pergunta(null, "Você é a favor do porte de arma?","Sim","Sim",true,city,null);
		Pergunta perg3 = new Pergunta(null,"Teste","Sim","Sim",true,city,null);
